...
public class PlanetWorldChunkManager extends WorldChunkManager {
    ...
    protected PlanetWorldChunkManager()
    {
    ...
    public PlanetWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public PlanetWorldChunkManager(World par1World)
    {
